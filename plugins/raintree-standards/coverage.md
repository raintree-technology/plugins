...
| Public project showcase | `MARKETING-PROJECT-SHOWCASE`, `WRITING-FUNCTIONAL`, `WEB-QUALITY`, public-web profile | Search Console when applicable | Draft; independent writing and accessibility review pending |
